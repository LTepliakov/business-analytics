...
select 		id, parent_balance_id as parent_id
			...
			, case 	when Master_Account_ID = 4112 and ingestion_date<='2023-06-14' then 0.01066667 --'Saudi Manpower Solutions Co.', Thomas will and will upload correct rates before 2023-06-14
					...
					when Master_Account_ID = 9198 and ingestion_date<='2023-06-14' then  0.01120 --Arabian Oud Trading Company.
					when Master_Account_ID = 4154 and ingestion_date<='2023-06-14' then  0.01146667 --Takamol Holding
